...
# Fetch data from the database
    ...
    fetchthree_button = Button(button_frame, text="Payroll DATA TABLE", command=lambda: display_data(scrollable_frame, fetch_data('payrollseris'), payroll_headers, payroll_col_widths))
